...
rootProject.name='RumiMixArenaBoardV050'
include ':app'
GRADLE
...
GRADLE
mkdir -p app/src/main/java/com/rumix/arena/board app/src/main/res/values app/src/main/res/drawable "$WWW" "$DIST"
sed 's/package com\.rumix\.arena\.online;/package com.rumix.arena.board;/' rumix-v043/MainActivity.java > app/src/main/java/com/rumix/arena/board/MainActivity.java
...
grep -q 'style-v050.css' "$WWW/index.html"
grep -q 'ux-v050.js' "$WWW/index.html"
grep -q 'peerjs.js' "$WWW/index.html"
! grep -q 'https://unpkg.com' "$WWW/index.html"
grep -q 'v05Stage' "$WWW/ux-v050.js"
grep -q 'pointerdown' "$WWW/ux-v050.js"
cat > app/build.gradle <<'GRADLE'
plugins { id 'com.android.application' }
android {
  namespace 'com.rumix.arena.board'
  compileSdk 35
  defaultConfig {
    applicationId 'com.rumix.arena.board.v050'
    minSdk 24
    targetSdk 35
    versionCode 50
    versionName '0.5.0'
...
<shape xmlns:android="http://schemas.android.com/apk/res/android" android:shape="rectangle"><corners android:radius="30dp"/><gradient android:startColor="#061B3F" android:centerColor="#0B58AD" android:endColor="#FFC62E" android:angle="45"/></shape>
EOF2
cat > app/src/main/AndroidManifest.xml <<'EOF2'
<manifest xmlns:android="http://schemas.android.com/apk/res/android"><uses-permission android:name="android.permission.INTERNET"/><application android:theme="@style/AppTheme" android:label="Rumi Mix Arena" android:icon="@drawable/app_icon" android:roundIcon="@drawable/app_icon" android:usesCleartextTraffic="false" android:allowBackup="false"><activity android:name="com.rumix.arena.board.MainActivity" android:exported="true" android:screenOrientation="landscape"><intent-filter><action android:name="android.intent.action.MAIN"/><category android:name="android.intent.category.LAUNCHER"/></intent-filter><intent-filter><action android:name="android.intent.action.VIEW"/><category android:name="android.intent.category.DEFAULT"/><category android:name="android.intent.category.BROWSABLE"/><data android:scheme="rumixarena" android:host="join"/></intent-filter></activity></application></manifest>
EOF2
gradle --no-daemon :app:assembleDebug
APK="$DIST/RumiMixArena-v0.5.0-BOARD-ONLINE.apk"
...
Rumi Mix Arena v0.5.0 BOARD ONLINE
Nova jogabilidade horizontal: mesa azul em tela cheia, rack de madeira, peças estreitas, jogadores à esquerda, ações à direita, arrastar peças para preparação, toque prolongado em grupos e dicas ocultas por padrão.
Modos: Online, CPU, Treino, Clássico, Letras, Misto e MegaRumiX.
TXT
(cd "$DIST" && zip -9 RumiMixArena-v0.5.0-BOARD-ONLINE.zip RumiMixArena-v0.5.0-BOARD-ONLINE.apk SHA256.txt ASSINATURA.txt APK-INFO.txt PERMISSOES.txt LEIA-ME.txt)
unzip -t "$DIST/RumiMixArena-v0.5.0-BOARD-ONLINE.zip"
echo 'RUMIX_V050_BOARD_ONLINE_BUILD_OK'
